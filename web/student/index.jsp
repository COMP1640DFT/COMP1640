                             ...
                             <c:forEach var="c" items="${beanAllClaim.listClaimUnresolved}">
                                <tr>
                                    ...
                                    <c:if test="${c.status == 1}">
                                        ...
                                        <td>
                                        <a href="StudentsController?idCM=${c.idClaim}&idUser=${idUser}&action=viewAllClaim">View</a>|<a href="StudentsController?action=AddClaimPage&idC=${c.idSubject}&idCM=${c.idClaim}">Up Claim</a>
                                    </td>
                                </tr>
                            </c:forEach>
<!--                                
