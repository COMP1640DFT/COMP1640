            ...
            <div class="sidebar-menu">
                ...
                <ul id="main-menu" class="">
                    ...
                    <li class="active">
                        ...
                        <li><a href="eccoorChangePwd.jsp"><i class="glyphicon glyphicon-log-out"></i>Change password</a></li>
                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form name="changePass" action="Controller?action=changePass" onsubmit="return validate()" method="post" class="form-horizontal form-groups-bordered">
